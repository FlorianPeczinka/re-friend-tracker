...
export class ExampleTranslationService extends TranslationService {
  protected getTranslation(key: string): string {
    const myTranslations = this.createTranslationMap(
      this.getExampleTranslations(),
    );
  ...
  private getExampleTranslations() {
    ...
    return {
      ...
      "ActivityName": "Name",
      "ActivityDate": "Datum",
      "ActivityComments": "Kommentare",
      "GroupCreationDate": "Datum",
      "GroupComments": "Kommentare",
    };
  }
}
